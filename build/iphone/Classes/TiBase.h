...
// in simulator we redefine to format for Futbol Developer console
...
{\
	NSString * exceptionName = [@"org.futbol." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.futbol";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIFutbolNativeItemNone = -1, 
	UIFutbolNativeItemSpinner = -2,
	UIFutbolNativeItemProgressBar = -3,
	
	UIFutbolNativeItemSlider = -4,
	UIFutbolNativeItemSwitch = -5,
	UIFutbolNativeItemMultiButton = -6,
	UIFutbolNativeItemSegmented = -7,
	
	UIFutbolNativeItemTextView = -8,
	UIFutbolNativeItemTextField = -9,
	UIFutbolNativeItemSearchBar = -10,
	
	UIFutbolNativeItemPicker = -11,
	UIFutbolNativeItemDatePicker = -12,
	
	UIFutbolNativeItemInfoLight = -13,
	UIFutbolNativeItemInfoDark = -14,
	
	UIFutbolNativeItemDisclosure = -15,
	
	UIFutbolNativeItemContactAdd = -16
};
